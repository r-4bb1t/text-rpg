...
example:
{
  ...
  "longDescription": "눈이 가득 쌓인 산이다. 산 정상에는 눈이 쌓인 동굴이 있다. 눈이 많이 쌓여 있어서 발이 미끄러울 수 있다.",
  "startLogs": [
...
{
  "key": string; // 던전의 key입니다. 영어로 작성해주세요.
  "name": string; // 던전의 이름입니다.
  "description": string; // 던전에 대한 간단한 설명입니다.
  "longDescription": string; // 던전에 대한 자세한 설명입니다. 지형을 최대한 상세히 작성해주세요.
  "startLogs": string[]; // 던전에 입장했을 때 나타나는 로그입니다. 최대한 상세한 주변 상황을 작성해주세요.
  ...
  }[]; // 던전에 등장하는 NPC들입니다. 없으면 빈 배열을 넣어주세요.
